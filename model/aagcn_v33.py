...
if __name__ == '__main__':
    ...
    sd = torch.load('./data/data/ntu_result/xview/aagcn_v33_joint/220221150001_nopad_3ks_lowerlr_noaug_rel_pool_withAa/ntu_cv_aagcn_joint-11-7056.pt')
