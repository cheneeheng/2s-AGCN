...
def get_parser():
    ...
    parser.add_argument('--step',
                        ...
                        default=[20, 40, 60],
                        nargs='+',
                        help='the epoch where optimizer reduce the learning rate')  # noqa
    ...
    parser.add_argument('--llrd-factor',
                        type=float,
                        default=0.5,
    ...
    # scheduler
    parser.add_argument('--scheduler', default='', help='pytorch lr scheduler')
    parser.add_argument('--anneal-strategy', default='cos')
